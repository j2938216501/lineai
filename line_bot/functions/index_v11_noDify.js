...
//每日推播英文單字
// import { processDailyVocabulary } from "./scheduled/daily_vocabulary.js";
...
//正式網址:https://api-4ugb2fo6hq-de.a.run.app/dify
//測試網址: https://blameable-kristin-proindustrialization.ngrok-free.dev/lineai-e8687/asia-east1/api/dify
...
//正式網址：https://api-4ugb2fo6hq-de.a.run.app/dailyVocabulary
//測試網址：https://blameable-kristin-proindustrialization.ngrok-free.dev/lineai-e8687/asia-east1/api/dailyVocabulary

export const dailyVocabularyPush = onSchedule(
  {
      schedule: "0 9 * * *", // 每天早上 9 點執行
      timeZone: "Asia/Taipei",
      region: "asia-east1",
  },
  async (event) => {
      await processDailyVocabulary();
  }
);

// 手動觸發每日單字推播 API（測試用）
app.get("/dailyVocabulary", async (req, res) => {
  const result = await processDailyVocabulary();
