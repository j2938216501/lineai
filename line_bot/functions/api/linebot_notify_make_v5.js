        ...
        for (const event of events) {
            ...
            if (event.type === "message" && event.message.type === "text") {
                ...
                try {
                    ...
                    if (userMessage.startsWith('/porduct ')) {
                        const productName = userMessage.substring(7).trim();
                        const stockResponse = await handleStockQuery(productName);
